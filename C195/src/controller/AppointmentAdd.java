...
/** Represents a form for adding an appointment.
 */
public class AppointmentAdd {
    ...
    /** Gets customer id from the customer name combo box and displays said customer id in the customer id text box.
    ...
    /** Closes the Add Appointment window when Cancel button is clicked.
     * @param e Parameter not used.
     */
    public void cancelAddAppt(ActionEvent event) throws IOException {
    ...
    /** Saves appointment information in database.
     * @param e Parameter not used.
     */
    public void saveAddAppt(ActionEvent event) throws SQLException {
        Integer apptID = 0;
        String title = null;
    ...
    /** Initializes the data for the Appointment Add form.
     */
